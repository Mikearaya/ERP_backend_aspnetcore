 ...
 * @Last Modified Time: Aug 9, 2019 11:17 AM
...
namespace BionicERP.Application.Procurment.PurchaseOrders.Models {
    public class PurchaseOrderDetailView {
        public PurchaseOrderDetailView () {
            PurchaseOrderItems = new List<PurchaseOrderItemView> ();
        }
        ...
        public IEnumerable<PurchaseOrderItemView> PurchaseOrderItems { get; set; }
        ...
        public static Expression<Func<PurchaseOrder, PurchaseOrderDetailView>> Projection {
            get {
                return po => new PurchaseOrderDetailView () {
                    ...
                    PurchaseOrderItems = (po.StockBatch.Count != 0) ?
